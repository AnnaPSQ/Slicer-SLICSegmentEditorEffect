...
class SegmentEditorSegmentEditorSlic(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "SegmentEditorSegmentEditorSlic"
...
class SegmentEditorSegmentEditorSlicTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_SegmentEditorSlic1()

  def test_SegmentEditorSlic1(self):
    """
    ...
    The test can be executed from SelfTests module (test name: SegmentEditorSegmentEditorSlic)
    """

    self.delayDisplay("Starting test_SegmentEditorSlic1")
    ...
    segmentEditorWidget.setActiveEffectByName("SegmentEditorSlic")
    ...
    self.delayDisplay('test_SegmentEditorSlic1 passed')
