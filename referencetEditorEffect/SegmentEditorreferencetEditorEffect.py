...
class SegmentEditorreferencetEditorEffect(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "SegmentEditorreferencetEditorEffect"
...
class SegmentEditorreferencetEditorEffectTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_referencetEditorEffect1()

  def test_referencetEditorEffect1(self):
    """
    ...
    The test can be executed from SelfTests module (test name: SegmentEditorreferencetEditorEffect)
    """

    self.delayDisplay("Starting test_referencetEditorEffect1")
    ...
    segmentEditorWidget.setActiveEffectByName("referencetEditorEffect")
    ...
    self.delayDisplay('test_referencetEditorEffect1 passed')
